...
@Component
class RecordToUzumAccountShopItemEntityWithLimitDataMapper : RecordMapper<UzumAccountShopItemEntityWithLimitData> {

    override fun convert(record: Record): UzumAccountShopItemEntityWithLimitData {
        return UzumAccountShopItemEntityWithLimitData(
